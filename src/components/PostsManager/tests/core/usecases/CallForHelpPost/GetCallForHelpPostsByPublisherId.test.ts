...
describe('Get Call For Help Posts List by publisher id', () => {
    ...
    it('given a user do not exist, when trying to get his call for help posts, then should fail', async () => {
    ...
    it('given a user who have no call for help posts, when trying to get the posts that user publish, then return an empty list', async () => {
    ...
    it('given a user who one call for help posts, when trying to get the posts that user publish, then return that post', async () => {
    ...
    it('given a user who a lot of call for help posts, when trying to get the posts that user publish, then return all those posts ordered by creation time descending', async () => {
        const publisherId = faker.datatype.uuid();
